  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans transition-colors duration-300">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 print:hidden font-sans">
          <div className="w-full lg:w-auto">
            ...
            <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 mt-1">
              View and print daily checklist logs.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full lg:w-auto">
            <select
              ...
              className="flex-1 lg:flex-none px-3 sm:px-4 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              {[...Array(12)].map((_, i) => (
            ...
            <Link
              ...
              className="w-full sm:w-auto px-4 sm:px-6 py-2 bg-blue-600 text-white rounded-lg text-sm sm:text-base font-bold hover:bg-blue-700 transition-colors shadow-md flex items-center justify-center gap-2"
            >
        ...
        <div className="bg-white dark:bg-slate-800 p-4 sm:p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 print:shadow-none print:border-none print:p-0">
          <div className="overflow-x-auto -mx-4 sm:mx-0">
            <div ref={componentRef} className="min-w-[1000px] sm:min-w-0 px-4 sm:px-0">
                ...
                <table className="w-full text-xs text-left border-collapse">
                  <thead>
                    <tr className="bg-slate-100 dark:bg-slate-700 print:bg-gray-200 text-slate-700 dark:text-slate-200 print:text-black">
                      <th className="border p-2 text-center min-w-[50px]" rowSpan={2}>Date</th>
                      <th className="border p-2 text-center" rowSpan={2}>Officer</th>
